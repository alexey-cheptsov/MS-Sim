...
int main (int argc, char* argv[]) {
    ...
    mpi_map.add({"Q0_q7", 8});
    mpi_map.add({"Q0_q8", 9});
    mpi_map.add({"Q0_q9", 10});
    mpi_map.add({"Q0_p0", 11});
    mpi_map.add({"Q0_p1", 12});
    mpi_map.add({"Q0_p2", 13});
    mpi_map.add({"Q0_p3", 14});
    mpi_map.add({"Q0_p4", 15});
    mpi_map.add({"Q0_p5", 16});
    mpi_map.add({"Q0_p6", 17});
    mpi_map.add({"Q0_p7", 18});
    mpi_map.add({"Q0_p8", 19});
    ...
    Q0->add_buffer_value(0, Commands_Q::id);
    Q0->add_buffer_value(0, Commands_Q::stop);
