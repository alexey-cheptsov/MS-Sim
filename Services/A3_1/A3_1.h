...
namespace A3_1 {
    ...
    /*
     * Microservice for Q+Q+Q - air section with leakage
     */
    ...
    /*AM*/	float AM_S_,    float AM_R_,    float AM_L_,
    /*VS*/	float VS_S_,    float VS_R_,    float VS_L_,
	    ...
	    Q_AM = new Q(4/*id*/, "Q_AM", communicator_,
                    "AM" /*element*/, section_, network_,
                    mon_opts_,
                    AM_S_ /*S*/, AM_R_ /*R*/, AM_L_ /*L*/, dX_, solv_params_);
		
	    Q_VS = new Q(5/*id*/, "Q_VS", communicator_,
	...
	void init_proxies() {
	    ...
	    add_proxy(new LocalIntBuffer  (id, id_str,  Proxies_AM::command_flow,  communicator));
    	    ...
    	    add_proxy(new LocalFloatBuffer(id, id_str,  Proxies_AM::set_Qs,        communicator));
    	    add_proxy(new LocalFloatBuffer(id, id_str,  Proxies_AM::get_Qs,        communicator));
    	    ...
    	    add_proxy(new LocalFloatBuffer(id, id_str,  Proxies_AM::set_R_reg,     communicator));
    	    add_proxy(new LocalFloatBuffer(id, id_str,  Proxies_AM::get_R_reg,     communicator));
	...
	void set_communications() {
	    ...
	    communicator->add_comm_link(new CommLink("Q_Streb" /*snd_id*/, Ports_Q::get_Q,
            ...
            communicator->add_comm_link(new CommLink("Q_Streb" /*snd_id*/, Ports_Q::get_P,
                                                 ...
                                                 N_Streb-1 /*size*/));
		// AM
	    communicator->add_comm_link(new CommLink("Q_AM" /*snd_id*/, Ports_Q::get_Q,
                                                 master /*rcv_id*/, Proxies_AM::get_Q + proxy_disp  /*port*/,
                                                 N_AM /*size*/));
            communicator->add_comm_link(new CommLink("Q_AM" /*snd_id*/, Ports_Q::get_P,
                                                 master /*rcv_id*/, Proxies_AM::get_P + proxy_disp  /*port*/,
                                                 N_AM-1 /*size*/));
		// VS
	    communicator->add_comm_link(new CommLink("Q_VS" /*snd_id*/, Ports_Q::get_Q,
                                                 master /*rcv_id*/, Proxies_VS::get_Q + proxy_disp  /*port*/,
                                                 N_VS /*size*/));
            communicator->add_comm_link(new CommLink("Q_VS" /*snd_id*/, Ports_Q::get_R_reg,
                                                 master /*rcv_id*/, Proxies_VS::get_R_reg + proxy_disp  /*port*/,
                                                 N_VS /*size*/));
            communicator->add_comm_link(new CommLink("Q_VS" /*snd_id*/, Ports_Q::get_P,
	...
	virtual void command__set_Q_VS() {
	    ...
	    //
            ...
            add_proxy_value<int>(Proxies_VS::command_flow, Commands_Q::set_R_reg /*value*/);
            proxy_flush_collective_replicate(Proxies_VS::command_flow);
            proxy_clear(Proxies_VS::command_flow);
	    ...
	    add_proxy_value<int>(Proxies_OS::command_flow, Commands_Q::simulation /*value*/);
            ...
            proxy_clear(Proxies_Streb::command_flow);
        	// AM
            add_proxy_value<int>(Proxies_AM::command_flow, Commands_Q::simulation /*value*/);
            proxy_flush_collective_replicate(Proxies_AM::command_flow);
            proxy_clear(Proxies_AM::command_flow);
        	// VS
            add_proxy_value<int>(Proxies_VS::command_flow, Commands_Q::simulation /*value*/);
            proxy_flush_collective_replicate(Proxies_VS::command_flow);
            proxy_clear(Proxies_VS::command_flow);
        	// P
	    ...
	    proxy_flush_collective_replicate(Proxies_OS::command_flow);
            ...
            proxy_clear(Proxies_Streb::command_flow);
        	// AM
            add_proxy_value<int>(Proxies_AM::command_flow, Commands_Q::save /*value*/);
            proxy_flush_collective_replicate(Proxies_AM::command_flow);
            proxy_clear(Proxies_AM::command_flow);
        	// VS
            add_proxy_value<int>(Proxies_VS::command_flow, Commands_Q::save /*value*/);
            proxy_flush_collective_replicate(Proxies_VS::command_flow);
            proxy_clear(Proxies_VS::command_flow);
        	// P
	    ...
	    proxy_clear(Proxies_OS::command_flow);
            ...
            proxy_clear(Proxies_Streb::command_flow);
        	// AM
            add_proxy_value<int>(Proxies_AM::command_flow, Commands_Q::stop /*value*/);
            proxy_flush_collective_replicate(Proxies_AM::command_flow);
            proxy_clear(Proxies_AM::command_flow);
        	// VS
            add_proxy_value<int>(Proxies_VS::command_flow, Commands_Q::stop /*value*/);
            proxy_flush_collective_replicate(Proxies_VS::command_flow);
            proxy_clear(Proxies_VS::command_flow);
        	// P
	    ...
	    add_proxy_value<int>(Proxies_OS::command_flow, Commands_Q::id /*value*/);
            ...
            proxy_clear(Proxies_Streb::command_flow);
        	// AM
            add_proxy_value<int>(Proxies_AM::command_flow, Commands_Q::id /*value*/);
            proxy_flush_collective_replicate(Proxies_AM::command_flow);
            proxy_clear(Proxies_AM::command_flow);
        	// VS
            add_proxy_value<int>(Proxies_VS::command_flow, Commands_Q::id /*value*/);
            proxy_flush_collective_replicate(Proxies_VS::command_flow);
            proxy_clear(Proxies_VS::command_flow);
        	// P
	...
	virtual void command__init_time() {
	    ...
	    add_proxy_value<int>(Proxies_OS::command_flow, Commands_Q::init_time /*value*/);
            ...
            proxy_clear(Proxies_Streb::command_flow);
        	// AM
            add_proxy_value<int>(Proxies_AM::command_flow, Commands_Q::init_time /*value*/);
            proxy_flush_collective_replicate(Proxies_AM::command_flow);
            proxy_clear(Proxies_AM::command_flow);
        	// VS
            add_proxy_value<int>(Proxies_VS::command_flow, Commands_Q::init_time /*value*/);
            proxy_flush_collective_replicate(Proxies_VS::command_flow);
            proxy_clear(Proxies_VS::command_flow);
        	// P
	...
	virtual void command__flush_data() {
	    ...
	    add_proxy_value<int>(Proxies_OS::command_flow, Commands_Q::flush_data /*value*/);
            ...
            proxy_clear(Proxies_Streb::command_flow);
        	// AM
            add_proxy_value<int>(Proxies_AM::command_flow, Commands_Q::flush_data /*value*/);
            proxy_flush_collective_replicate(Proxies_AM::command_flow);
            proxy_clear(Proxies_AM::command_flow);
        	// VS
            add_proxy_value<int>(Proxies_VS::command_flow, Commands_Q::flush_data /*value*/);
            proxy_flush_collective_replicate(Proxies_VS::command_flow);
            proxy_clear(Proxies_VS::command_flow);
        	// P
