...
namespace G2_1 {
	...
	enum Port_codes {
	    command_flow        = A1_2::Ports_p::command_flow + Proxies_qm::get_qm0+1 /*displ*/,

            set_p               = A1_2::Ports_p::set_p        + Proxies_qm::get_qm0+1 /*displ*/,
            get_p               = A1_2::Ports_p::get_p        + Proxies_qm::get_qm0+1 /*displ*/
	};
    };
}; // namespace G2_1
